...
(function (factory) {
  ...
  var Table = function () {
    ...
    this.createTable = function (colCount, rowCount) {
      ...
      trHTML = trs.join('');
      return $('<table class="table table-bordered table-condensed table-striped">' + trHTML + '</table>')[0];
    };
  };
  ...
  var Renderer = function () {
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      var $editable = $('<div class="note-editable" contentEditable="' + isContentEditable + '" style="max-height:500px;"></div>')
          .prependTo($editor);
      if (options.height) {
